...
//        if ((start_date.isEmpty() || start_date.equals("(dd-mm-yyyy)")) &&
//                (end_date.isEmpty() || end_date.equals("(dd-mm-yyyy)"))){
//            JOptionPane.showMessageDialog(null, "Start date and end date are empty", "Error", JOptionPane.ERROR_MESSAGE);
//        }
//        else
        if ((!start_date.equals("(dd-mm-yyyy)") || start_date.isEmpty()) && !isValidDate(start_date)){
            ...
            Object[][] data = adminController.searchActiveUser( start_date, end_date, name, session, option);
